...
public class PointSelectState extends State {
	...
	public void mouseReleased(MouseEvent e) {
		// TODO Auto-generated method stub
		//Ajouter la liste de figure en cache au flux
	...
	public void mouseMoved(MouseEvent e) {
		// TODO Auto-generated method stub
		if(!(editeur.component.getComponent(1) instanceof JLabel)) return;
	...
	public void backspaceTyped(ActionEvent e) {
		...
		//Choisir quoi faire selon la figure qui contient le point selectionne
		
		if(selectedFig instanceof Polygone) //Si dans un polygone supprimer le sommet
		{
			Polygone poly = (Polygone) selectedFig;
			poly.getSommets().remove(selectedPoint);
		}else if(selectedFig instanceof Segment) //Si segment supp le segment et ajouter le point l'autre point
		{
		...
		//supprimer les infos sur l'ancien point
		editeur.component.remove(2);
		editeur.component.repaint();
	}
